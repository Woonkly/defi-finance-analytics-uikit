...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#262948", contrast: "#000000", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#5E7FA3", textDisabled: "#BDC2C4", textSubtle: "#5E7FA3", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#2a4cca", background: "#171727", backgroundDisabled: "#1f1f1f", backgroundAlt: "#27262c", backgroundAlt2: "rgba(39, 38, 44, 0.7)", cardBorder: "#262948", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#1b1d31", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#e7e8ea", textDisabled: "#666171", textSubtle: "#a8a9ad", disabled: "#524B63", gradients: {
